...
import RuEs5_6 from '../language/RuEs5_6';
import AmEs5_6 from '../language/AmEs5_6';
import Wrapper from '../components/Wrapper';
import FrEs5_6 from '../language/FrEs5_6';
import ArJSEs5_6 from '../language/ArJSEs5_6';
import JpJsEs5_6 from '../language/JpJSEs5_6';
import EsJSEs5_6 from '../language/EsJSEs5_6';
 ...
 function JsEs5_6() {
  ...
  useEffect(() => {
    switch (language) {
      ...
      case 'am':
        ...
        break;
        case 'fr':
        document.title = 'Objet global en JavaScript, Manipulation des chaînes, Recherche de chaîne, RegEx | codeportall.com';
        break;
        case 'es':
        document.title = 'Objeto global en JavaScript | Manipulación de cadenas | Expresiones regulares';
        break;
        case 'ar':
        document.title = 'الكائن العالمي في JavaScript | تلاعب السلاسل في JavaScript ES5 | البحث في السلاسل | التعبيرات العادية | JavaScript';
        break;
        case 'jp':
        document.title = 'JavaScriptのグローバルオブジェクト | JavaScript ES5での文字列操作 | RegEx | あなたのサイト名';
        break;
      default:
        document.title = 'JavaScript ES5-6 | java script lesson 6 | ՋավաՍկրիպտ ';
    }
  }, [language]);
  ...
  return (
    ...
    <p>Global object methods can be called from anywhere in the code, without the need to create an instance of the object. However, care should be taken when extending the global object with custom methods, as they can potentially conflict with built-in methods or other custom methods.</p>
    
    <p>It is important to note that in modern JavaScript environments, the global object is not always available in all contexts, such as in module-based code or in strict mode.</p>
