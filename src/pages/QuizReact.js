...
function Quiz() {
  ...
  useEffect(() => {
    switch (language) {
      case 'en':
        document.title = 'React Redux Online Test: Difficult Level - Test Your Knowledge Now!';
        break;
      case 'ru':
        document.title = 'Онлайн опросы на React и Redux: Сложный уровень - Проверьте свои знания сейчас!';
        break;
      case 'hy':
        document.title = 'React & Redux Բարդ Մակարդակ - Ստուգեք ձեր գիտելիքները։';
        break;
      default:
  ...
  Explore your React.js knowledge with this interactive quiz designed to test your 
  ...
  <ul className="quiz-list">
    ...
    <li className="quiz-list-item">
      ...
      Encounter a variety of topics, including React components, lifecycle methods, 
      state management with Redux, and more.
    </li>
    <li className="quiz-list-item">
  ...
  <p className="quiz-note">
    <strong>Note:</strong>
    Covering essential React.js concepts, this quiz serves as a valuable self-assessment tool and a 
    means to enhance your React.js proficiency. 
  </p>
  <p className="quiz-outro">Enjoy the quiz and put your React.js knowledge to the test!</p>
</div>
