...
import RuEs5_7 from '../language/RuEs5_7';
import AmEs5_7 from '../language/AmEs5_7';
import Wrapper from '../components/Wrapper';
import FrEs5_7 from '../language/FrEs5_7';
import JpJSEs5_7 from '../language/JpJSEs5_7';
import ArJSEs5_7 from '../language/ArJSEs5_7';
import EsJSEs5_7 from '../language/EsJSEs5_7';
  ...
  useEffect(() => {
    switch (language) {
      ...
      case 'am':
        ...
        break;
        case 'fr':
        document.title = "Programmation orientée objet, OOP, JavaScript ES5, fonctions constructeurs, prototypes, encapsulation, fermetures, création d'objets, expression régulière, prototype, instanceof ";
        break;
        case 'es':
        document.title = 'Programación Orientada a Objetos (POO) en JavaScript ES5 | Tutoriales de POO - codeportall';
        break;
        case 'ar':
        document.title = 'البرمجة | الشيئية | OOP | JavaScript | ES5 | وظائف | المُنشئ | نموذج | الكائن | التجزئة | الإغلاقات | النموذج | الأولي | توريث | مشاركة | الأساليب | الخصائص | الإنشاء | القائم | على | المُنشئ | الكائن | القائم | على | المُنشئ| RegExp, النموذج| __proto__ | التحقق | instanceof';
        break;
        case 'jp':
        document.title = 'オブジェクト指向プログラミング、OOP、コンストラクタ関数、プロトタイプ、カプセル化、クロージャ、プリミティブ値、Objectコンストラクタ、Arrayコンストラクタ、正規表現、プロトタイプベースのプログラミング、Object.create()、instanceof ';
        break;
      default:
        document.title = 'JavaScript ES5-7 | java script lesson 7 | ՋավաՍկրիպտ';
    }
  }, [language]);
