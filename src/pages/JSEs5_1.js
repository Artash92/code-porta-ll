...
import FrEs5_1 from '../language/FrEs5_1';
import RuEs5_1 from '../language/RuEs5_1';
import AmEs5_1 from '../language/AmEs5_1';
import ArJSEs5_1 from '../language/ArJSEs5_1';
import JpJSEs5_1 from '../language/JpJSEs5_1';
import EsJSEs5_1 from '../language/EsJSEs5_1';
  ...
  useEffect(() => {
    switch (language) {
      ...
      case 'am':
        ...
        break;
        case 'fr':
        document.title = 'JavaScript, Brendan Eich, ECMAScript, opérateurs booléens, expressions JavaScript, valeurs spéciales, variables, null, undefined | var modeleVoiture = "Tesla"; ';
        break;
        case 'es':
        document.title = 'JavaScript fue creado en 1995 por Brendan Eich mientras trabajaba en Netscape Communications Corporation. El lenguaje originalmente se llamaba Mocha | JavaScript: Historia, Tipos de Datos, Operadores y Variables ';
        break;
        case 'ar':
        document.title = 'جافا سكريبت | ECMAScript | تعبيرات جافا سكريبت | أنواع البيانات | المتغيرات في جافا سكريبت ';
        break;
        case 'jp':
        document.title = 'JavaScript, ECMAScript, プログラミング言語, Brendan Eich, Netscape Communications Corporation, LiveScript, Mozilla, Brave Software, データ型, Boolean, 比較演算, NaN, typeof, isNaN(), isFinite(), 変数, Null, Undefined, 型の強制変換, parseInt, parseFloat, Number関数';
        break;
      default:
