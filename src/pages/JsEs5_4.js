...
import RuEs5_4 from '../language/RuEs5_4';
import AmEs5_4 from '../language/AmEs5_4';
import Wrapper from '../components/Wrapper';
import FrEs5_4 from '../language/FrEs5_4';
import ArJSEs5_4 from '../language/ArJSEs5_4';
import JpEs5_4 from '../language/JpJSEs5_4';
import EsJSEs5_4 from '../language/EsJSEs5_4';
  ...
  useEffect(() => {
    switch (language) {
      ...
      case 'am':
        ...
        break;
        case 'fr':
        document.title = 'Récurssion, Objet, Propriétés, Méthodes, Type orienté objet, Fonction en tant qu\'objet, this, Arguments - Guide JavaScript';
        break;
        case 'es':
        document.title = 'Recursión en JavaScript: Ejemplos, Funciones, Objeto, y Más';
        break;
        case 'ar':
        document.title = '(التكرار) Recursion | Programming technique (تقنية البرمجة) | Objects (الكائنات) | Array (المصفوفة) | Parameters (الوسائط) | Object-oriented programming (البرمجة الموجهة نحو الكائنات) | Data structure (هيكل البيانات)';
        break;
        case 'jp':
        document.title = '再帰, オブジェクト, プロパティ, メソッド, 関数, this, オブジェクト引数 ';
        break;
      default:
