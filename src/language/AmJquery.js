...
<p>jQuery-ն ապահովում է մի շարք գործառույթներ Document Object Model-ի (DOM) հետ աշխատելու, ինչպես նաև AJAX-ի (Asynchronous JavaScript and XML) հետ աշխատելու և անիմացիաներ ստեղծելու համար: Այն նաև հեշտացնում է բրաուզերի հետ համատեղելի կոդ գրելը, քանի որ jQuery գրադարանն ավտոմատ կերպով լուծում է բրաուզերի համատեղելիության խնդիրները:</p>    
