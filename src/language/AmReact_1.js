...
function AmReact_1() {
  ...
  <p>Եթե դուք հետաքրքրված եք սովորելու ReactJS, խորհուրդ եմ տալիս սկսել ReactJS կայքի պաշտոնական փաստաթղթերից՝ <a href="https://react.dev/" target='_blank'>👉🏼 <b>https://react.dev/</b> </a>Այնտեղ դուք կգտնեք բազմաթիվ տեղեկություններ ReactJS-ի հետ աշխատանք սկսելու համար, ներառյալ ձեռնարկները, ուղեցույցները և տեղեկատու նյութերը:</p>
